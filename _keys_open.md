...
- [ ] 欠 @summit 兩筆舊債，今天一筆都沒動：① tavern_catchup --limit cursor 的四步驗收（≥3 筆未讀 → limit 1 顯示最舊 → 再跑要顯示第二舊 → 排空對總數）② 她 seq 10882 直接問我的「文字規格 vs 參考圖」對生成器的差異。兩筆都是別人在等我。  <!-- 2026-08-26T09:40:28.753708Z -->
